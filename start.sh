...
for ((i=0; i<=2; i++)); do
    docker exec \
    -e "CORE_PEER_TLS_ROOTCERT_FILE=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/blockchain-a.com/peers/peer$i.blockchain-a.com/tls/ca.crt" \
    -e "CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/blockchain-a.com/users/Admin@blockchain-a.com/msp" \
    -e "CORE_PEER_LOCALMSPID=PeersAMSP" \
    -e "CORE_PEER_ADDRESS=peer$i.blockchain-a.com:7051" \
    cli peer channel join -b ${CHANNEL_NAME}.block

    docker exec \
    -e "CORE_PEER_TLS_ROOTCERT_FILE=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/blockchain-b.com/peers/peer$i.blockchain-b.com/tls/ca.crt" \
    -e "CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/blockchain-b.com/users/Admin@blockchain-b.com/msp" \
    -e "CORE_PEER_LOCALMSPID=PeersBMSP" \
    -e "CORE_PEER_ADDRESS=peer$i.blockchain-b.com:7051" \
    cli peer channel join -b ${CHANNEL_NAME}.block
done
...
docker exec \
-e "CORE_PEER_TLS_ROOTCERT_FILE=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/blockchain-b.com/peers/peer0.blockchain-b.com/tls/ca.crt" \
-e "CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/blockchain-b.com/users/Admin@blockchain-b.com/msp" \
-e "CORE_PEER_LOCALMSPID=PeersBMSP" \
-e "CORE_PEER_ADDRESS=peer0.blockchain-b.com:7051" \
cli peer channel update -o orderer0.consensus.com:7050 -c ${CHANNEL_NAME} -f ./channel-artifacts/PeersBMSPanchors.tx --tls ${CORE_PEER_TLS_ENABLED} --cafile /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/consensus.com/orderers/orderer0.consensus.com/msp/tlscacerts/tlsca.consensus.com-cert.pem
...
-e "CORE_PEER_LOCALMSPID=PeersAMSP" \
-e "CORE_PEER_ADDRESS=peer0.blockchain-a.com:7051" \
cli peer chaincode instantiate -o orderer0.consensus.com:7050 -C ${CHANNEL_NAME} -n ${CHAINCODE_FILENAME_NOEXT} -v 1.0 -c '{"Args":[""]}' -P "AND('PeersAMSP.member','PeersBMSP.member')" --tls ${CORE_PEER_TLS_ENABLED} --cafile /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/consensus.com/orderers/orderer0.consensus.com/msp/tlscacerts/tlsca.consensus.com-cert.pem
