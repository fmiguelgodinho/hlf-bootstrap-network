...
for l in {a..d}; do
  L=${l^^}
  docker exec \
  -e "CORE_PEER_TLS_ROOTCERT_FILE=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/blockchain-a${l}.com/peers/peer0.blockchain-a${l}.com/tls/ca.crt" \
