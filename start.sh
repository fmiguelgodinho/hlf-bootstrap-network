...
export CHAINCODE_INSTANTIATE_ARGS='{"Args":["{\"contract-id\":\"xcc\",\"contract-version\":1,\"available-functions\":[[\"type:query\",\"fn:query\",\"arg0:key(string)\",\"arg1:viewHistory(bool)\"],[\"type:query\",\"fn:queryAll\"],[\"type:invoke\",\"fn:put\",\"arg0:key(string)\",\"arg1:value(string)\"]],\"installed-on-nodes\":[\"peer0.blockchain-a.com\",\"peer0.blockchain-b.com\",\"peer0.blockchain-c.com\",\"peer0.blockchain-d.com\",\"peer0.blockchain-e.com\",\"peer0.blockchain-f.com\"],\"channel\":\"mainchannel\",\"signature-type\":\"multisig\",\"signing-nodes\":[\"peer0.blockchain-a.com\",\"peer0.blockchain-b.com\",\"peer0.blockchain-c.com\",\"peer0.blockchain-d.com\",\"peer0.blockchain-e.com\",\"peer0.blockchain-f.com\"],\"consensus-type\":\"bft\",\"consensus-nodes\":[\"orderer0.consensus.com\",\"orderer1.consensus.com\"]}","{\"max-records\":100,\"total-records\":0}"]}'
